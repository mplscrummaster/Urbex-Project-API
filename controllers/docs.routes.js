...
export const routes = [
  ...
  // scenarios
  { ________________________________: 'Scenarios' },
  ...
  // missions
  { ________________________________: 'Missions' },
  ...
  // blocks
  { ________________________________: 'Blocks' },
  ...
  // progress & bookmarks
  { ________________________________: 'Progress & bookmarks' },
  ...
  { ________________________________: 'Mission prerequisites' },
  { method: 'PUT', path: '/api/missions/:id/prerequisites' },
  { method: 'GET', path: '/api/missions/:id/prerequisites' },

  // players
  { ________________________________: 'Players' },
  ...
  // communes (read-only)
  { ________________________________: 'Communes' },
  ...
  // friends
  { ________________________________: 'Friends' },
  { method: 'GET', path: '/me/friends' },
  { method: 'GET', path: '/friends/:nickname' },
  { method: 'POST', path: '/friends/add' },
];
